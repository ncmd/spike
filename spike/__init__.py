...
from spike.views import default, rules, rulesets, sandbox, whitelists, whitelistsets, configeditor
...
def create_app(config_filename=''):
    ...
    app.register_blueprint(configeditor.configeditor, url_prefix='/configeditor')
